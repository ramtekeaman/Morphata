            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Jashne-E.sama Mehfil</h4>
                
                    </p>

                    <form method="post" enctype="multipart/form-data">
                      <?php
                        $dis = mysqli_query($con, "SELECT * FROM mehfil");
                      ...
                      while($row = mysqli_fetch_array($dis)){
                        ...
                        ?>
                          ...
                          <form method="post" action="del_mehfil.php" id="deleteForm_<?php echo $row['ID']; ?>">
