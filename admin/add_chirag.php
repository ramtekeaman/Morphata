...
<html lang="en">
  ...
  <div class="content-wrapper" style="display: flex; justify-content: center;">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card" >
        <div class="card-body">
          <h4 class="card-title">Add Chirag Service</h4>
          <p class="card-description">Chirag Form </p>
          <form class="forms-sample" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="imagetext" class="form-control" id="exampleInputEmail1" placeholder="Image Text Here">
                      ...
                      <button class="btn btn-light"><a href="chirag.php" style="text-decoration: none; color: black;">Cancel</a></button>
                    </form>
                    ...
                    <?php
                        if (isset($_POST['submit2'])) {
                            ...
                            $query = mysqli_query($con, "SELECT * FROM `chirag` WHERE `Image` = '$file_name'");
                            ...
                            if($count > 0)
                            {
                              ...
                              mysqli_query($con, "INSERT INTO `chirag`(`Image`, `Image-Text`) VALUES ('$file_name','$_POST[imagetext]')");
                              exit();
                            }
