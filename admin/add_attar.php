          ...
          <form class="forms-sample" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="imagetext" class="form-control" id="exampleInputEmail1" placeholder="Image Text Here">
                      ...
                      <button class="btn btn-light"><a href="attar.php" style="text-decoration: none; color: black;">Cancel</a></button>
                    </form>
                        ...
                        <?php
                            if (isset($_POST['submit2'])) {
                                ...
                                $query = mysqli_query($con, "SELECT * FROM `attar` WHERE `Image` = '$file_name'");
                                ...
                                if($count > 0)
                                {
                                  ...
                                  mysqli_query($con, "INSERT INTO `attar`(`Image`, `Image-Text`) VALUES ('$file_name','$_POST[imagetext]')");
                                  exit();
                                }
