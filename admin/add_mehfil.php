...
<html lang="en">
  ...
  <div class="content-wrapper" style="display: flex; justify-content: center;">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card" >
        <div class="card-body">
          <h4 class="card-title">Add Jashne-E.sama Mehfil Information</h4>
          <p class="card-description">Jashne-E.sama Mehfil Form </p>
          <form class="forms-sample" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="description" class="form-control" id="exampleInputEmail1" placeholder="Video Description Here">
                      ...
                      <button class="btn btn-light"><a href="sama-mehfil.php" style="text-decoration: none; color: black;">Cancel</a></button>
                    </form>
                    ...
                    <?php
                        if (isset($_POST['submit2'])) {
                          ...
                          $query = mysqli_query($con, "SELECT * FROM `mehfil` WHERE `Video` = '$file_name'");
                          ...
                          if($count > 0)
                            {
                                ...
                                mysqli_query($con, "INSERT INTO `mehfil`(`Video`, `Description`) VALUES ('$file_name','$_POST[description]')");
