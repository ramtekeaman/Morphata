...
<html lang="en">
  ...
  <div class="content-wrapper" style="display: flex; justify-content: center;">
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card" >
        <div class="card-body">
          <h4 class="card-title">Add Chadar Service</h4>
          <p class="card-description">Chadar Form </p>
          <form class="forms-sample" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="imagetext" class="form-control" id="exampleInputEmail1" placeholder="Image Text Here">
                      ...
                      <button class="btn btn-light"><a href="chadar.php" style="text-decoration: none; color: black;">Cancel</a></button>
                    </form>
                    ...
                    <?php
                        if (isset($_POST['submit2'])) {
                            ...
                            $query = mysqli_query($con, "SELECT * FROM `chadar` WHERE `Image` = '$file_name'");
                            ...
                            if($count > 0)
                            {
                              ...
                              mysqli_query($con, "INSERT INTO `chadar`(`Image`, `Image-Text`) VALUES ('$file_name','$_POST[imagetext]')");
                              exit();
                            }
