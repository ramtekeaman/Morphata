                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                      <?php
                        $dis = mysqli_query($con, "SELECT * FROM images");
                      ...
                      while($row = mysqli_fetch_array($dis)){
                        ...
                        ?>
                          ...
                          <form method="post" action="del_images.php">
                              ...
                              <button type="submit" name="delete_btn" onclick="return confirmDelete(<?php echo $row['ID']; ?>)" style="background-color: red; color: white; padding: 4px 10px; border: none; border-radius: 5px; margin-right: 10px; height: 26px"><i class="fa-solid fa-trash"></i></button>
